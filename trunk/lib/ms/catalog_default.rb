...
GERT_ENTRY_LOST = 'もうすぐみんな集まるみたい……。'
GERT_FIRST_LOST = 'それでは、私は国境にガードを呼びに行ってきます。大急ぎで往復しますが、無事到着するかどうか……。私が戻るまで皆さん夜に見張りをたてて安全を確保して下さい。'
...
#2011/02/23 add:tkt for anniversary start
START_LOST = <<END
昨夜遅く、隣村への林に生えている樹木に爪跡が発見されたとの連絡があった。本当に人狼がいるのだろうか……。不安にかられた村人は国境に駐留しているガードに助けを求めることにした。国境は村から離れておりガードがいつ到着するのか不明だった。
END
#2011/02/23 add:tkt for anniversary end
...
#2011/02/23 add:tkt for anniversary start
SUN_PHASE_LOST = 'ガードは未だ到着しない。村人たちは不安な面持ちのまま会議をはじめた。'
#2011/02/23 add:tkt for anniversary end
